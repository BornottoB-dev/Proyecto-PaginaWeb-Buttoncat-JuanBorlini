...
import { Search, ShoppingCart, Shield, LogOut, LogIn } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between gap-4 flex-wrap">
        ...
        >
          <div className="w-10 h-10 flex items-center justify-center shrink-0">
            <svg viewBox="0 0 36 36" className="w-10 h-10 drop-shadow-[2px_2px_0px_rgba(0,0,0,0.35)] group-hover:rotate-[180deg] transition-transform duration-500 ease-in-out">
              {/* Outer Button Circle */}
          ...
          <span className="text-2xl sm:text-3xl font-sedgwick text-brand-yellow uppercase group-hover:text-white transition-colors drop-shadow-[1.5px_1.5px_0px_rgba(0,0,0,1)]">
            BUTTONCAT
          </span>
        </button>
        ...
        <div className="flex-1 max-w-md min-w-[220px]">
          <div className="relative flex items-center">
            ...
            <button 
              ...
              className="absolute right-0 top-0 bottom-0 px-2.5 bg-brand-yellow border-l-2 border-black hover:bg-brand-orange hover:text-white flex items-center justify-center transition-colors cursor-pointer"
              title="Buscar"
            >
        ...
        <nav className="flex items-center gap-1.5 sm:gap-2.5 text-xs sm:text-sm font-black tracking-wide uppercase flex-wrap">
          ...
          >
            PERSONALIZAR
            <span className="absolute -top-2.5 -right-2 bg-brand-yellow text-black border border-black px-1.5 py-0.2 text-[9px] font-black uppercase shadow-brutal-sm">
              NEW
            </span>
          </button>
